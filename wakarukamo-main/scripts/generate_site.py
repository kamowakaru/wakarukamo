...
def md_to_html(md):
    ...
    while i < len(lines):
        ...
        # Standalone Markdown images. Handle these before ordinary inline links
        # so `![alt](src)` is rendered as an image instead of `!` + link card.
