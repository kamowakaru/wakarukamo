...
for a in all_articles:
    ...
    (adir/f"{a['slug']}.html").write_text(shell(a['title'], page, desc=a['description'], canonical_path=f'articles/{a["slug"]}.html', json_ld='' if a['draft'] else schema, noindex=a['draft'], og_image=f'{SITE_URL}/assets/images/thumbnails/{a["thumbnail"]}', page_type='article'), encoding='utf-8')
