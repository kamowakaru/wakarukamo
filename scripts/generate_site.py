...
for a in articles:
    ...
    schema = json.dumps({
        ...
        'mainEntityOfPage':article_url, 'author':{'@type':'Person','name':'ワカルカモ運営者','url':f'{SITE_URL}/about.html#author-profile'},
